<header class="navbar navbar-expand navbar-dark flex-column flex-md-row bd-navbar hitam border border-secondary border-top-0 border-right-0 border-left-0">
  <a class="navbar-brand mr-0 mr-md-2" href="index.php" aria-label="Bootstrap">
    ...
    <ul class="navbar-nav bd-navbar-nav flex-row">
      ...
      <div class="btn-group">
        ...
        <div class="dropdown-menu">
          ...
          <a class="dropdown-item" href="?tambah">Tambah User</a>
        </div>
      </div>
      &nbsp;
      <div class="btn-group">
        ...
        <div class="dropdown-menu">
          ...
          <a class="dropdown-item" href="?tambahfilm">Tambah Film</a>
        </div>
      </div>
      &nbsp;
      <div class="btn-group">
